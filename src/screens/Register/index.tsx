...
const createRegisterFormSchema = z.object({
   ...
   confirmPassword: z.string().min(8, "* Necessário pelo menos 8 caracteres")
  ...
  return (
    <div className={
      ...
      <div className="w-[1010px] pt-8 pr-16 pb-12 pl-10 border border-[#e9e9e9] rounded-lg shadow-md bg-white">
         ...
         <h2 className="text-lg  font-normal text-[#646464]">Crie seu cadastro para realizar suas solicitações</h2>
         </div>

         <FormProvider {...createRegisterForm}>
            <form onSubmit={handleSubmit(handleRegister)} className="flex flex-col w-full pl-10"> 
                           ...
                           render={({ field: { onChange } }) => (
                              ...
                              >
                                 ...
                                 <SelectContent>
                                    ...
                                    <SelectItem value="Big Data para Negócios">Big Data para Negócios</SelectItem>
